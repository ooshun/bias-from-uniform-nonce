...
CXXFLAGS =	-O2 -g -v -Wall -fmessage-length=0 -std=c++11 -fopenmp
CFLAGS =	-O2 -g -v -Wall -fmessage-length=0 -std=c99 -funroll-loops
LDFLAGS = -lpthread -lrt -lfftw3 -lfftw3_mpi -lgmp -lgmpxx -lm 
...
# ALL_TARGETS = $(MOCKSIG) $(FFT_BIN) $(ATTACK_MPI_BIN) $(SIGGEN_MPI_BIN) 
ALL_TARGETS = $(MOCKSIG) $(ATTACK_MPI_BIN) $(SIGGEN_MPI_BIN) 


# $(FFT_BIN): mocksig.o fft.o test_fft.cpp obj/c25519.a
# 	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS)

$(MOCKSIG_BIN): mocksig.o mocksig.cpp obj/c25519.a
